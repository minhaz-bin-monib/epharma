			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom example example-compact">
						...
						<!--begin::Form-->
						<form class="form" id="kt_form_1" method="post" action="{{route('admin.middle-banner.update',$midddleBanner->id)}}"enctype="multipart/form-data">
						@csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
										<input type="text" class="form-control" name="title" id="banner_title" value="{{$midddleBanner->title}}" />
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
									<textarea name="description" rows="8" cols="80" id="banner_description">{{$midddleBanner->description}}</textarea>
