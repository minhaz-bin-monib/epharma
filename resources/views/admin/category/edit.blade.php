			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom example example-compact">
						...
						<!--begin::Form-->
						<form class="form" id="kt_form_1" method="post" action="{{route('admin.category.update',($categorydata['id']))}}"enctype="multipart/form-data">
						@csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
										<input type="text" class="form-control" name="category_name" value="{{$categorydata['category_name']}}" />
	                ...
	                @endforeach
			        	...
			        	@include('admin.category.edit_append_categories_lavel')
				        </div>

									<div class="form-group row">
										<label class="col-form-label text-right col-lg-3 col-sm-12">Category URL *</label>
										<div class="col-lg-9 col-md-9 col-sm-12">
											<input type="url" class="form-control" name="url" value="{{$categorydata['url']}}" />
							...
							<div class="card-footer">
								<div class="row">
									<div class="col-lg-9 ml-lg-auto">
										<button type="submit" class="btn btn-primary font-weight-bold mr-2" name="submitButton">Update Category</button>
