			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom example example-compact">
						...
						<!--begin::Form-->
						<form class="form" id="kt_form_1" method="post" action="{{route('admin.product.update',($product['id']))}}"enctype="multipart/form-data">
						@csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
										<textarea name="description" id="" cols="120" rows="8">{{$product->description}}</textarea>
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
										<textarea name="meta_description" id="" cols="120" rows="8">{{$product->meta_description}}</textarea>
