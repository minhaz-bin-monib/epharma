			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom example example-compact">
						...
						<!--begin::Form-->
						<form class="form" id="kt_form_1" method="post" action="{{route('admin.section.update',$section->id)}}"enctype="multipart/form-data">
						@csrf
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-lg-9 col-md-9 col-sm-12">
										<input type="text" class="form-control" name="name" id="section_title" value="{{$section->name}}" />
							...
							<div class="card-footer">
								<div class="row">
									<div class="col-lg-9 ml-lg-auto">
										<button type="submit" class="btn btn-primary font-weight-bold mr-2" name="submitButton">Update Section</button>
