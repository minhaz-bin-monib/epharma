...
<html lang="en">
	...
	<head><base href="">
		...
		<!--begin::Fonts-->
		<link rel="stylesheet" href="{{asset('assets/admin/assets/css/loader.css')}}">
  ...
  .toggle.ios .toggle-handle { border-radius: 20px; }
	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed aside-enabled aside-static page-loading" >
		...
		<div id="kt_header_mobile" class="header-mobile header-mobile-fixed">
			<!--begin::Logo-->
			<a href="index.html">
				<img alt="Logo" src="{{asset('assets/admin/assets/media/logos/logo-letter-1.png')}}" class="logo-default max-h-30px" />
			</a>
			<!--end::Logo-->
			<!--begin::Toolbar-->
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('admin.section.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">sections</span>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('admin.middle-banner.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Middle  banners</span>
												</a>
											</li>
								...
								<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
									...
									<div class="menu-submenu">
										...
										<ul class="menu-subnav">
											...
											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('admin.dashboardlogo.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Dashboard logo</span>
												</a>
											</li>

											<li class="menu-item" aria-haspopup="true">
												<a href="{{route('admin.frontendlogo.index')}}" class="menu-link">
													<i class="menu-bullet menu-bullet-dot">
														<span></span>
													</i>
													<span class="menu-text">Frontend logo</span>
												</a>
											</li>
										...
										<div class="container d-flex align-items-stretch justify-content-between">
											...
											<div class="d-none d-lg-flex align-items-center mr-3">
												...
												<a href="{{route('admin.dashboard')}}">
													<img alt="Logo" src="{{asset('assets/admin/assets/media/logos/logo-letter-1.png')}}" class="logo-sticky max-h-35px" />
												</a>
												<!--end::Logo-->
...
@yield('content')
									<!--begin::Footer-->
									<div class="footer bg-white py-4 d-flex flex-lg-column" id="kt_footer" style="margin-top: 500px;">
										<!--begin::Container-->
										<div class="container d-flex flex-column flex-md-row align-items-center justify-content-between">
											<!--begin::Copyright-->
											<div class="text-dark order-2 order-md-1">
												<span class="text-muted font-weight-bold mr-2">2021©</span>
												<a href="https://essential-infotech.com/" target="_blank" class="text-dark-75 text-hover-primary">Essetial Infotech</a>
											</div>
											<!--end::Copyright-->
											<!--begin::Nav-->
		...
		<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
			...
			<div class="offcanvas-content pr-5 mr-n5">
				...
				<div class="navi navi-spacer-x-0 p-0">
					...
					<!--end:Item-->
					<!--begin::Item-->
					<a href="{{route('admin.setting')}}" class="navi-item">
						<div class="navi-link">
							<div class="symbol symbol-40 bg-light mr-3">
								<div class="symbol-label">
		...
		<script src="{{asset('assets/admin/assets/js/pages/crud/forms/validation/form-controls.js')}}"></script>
